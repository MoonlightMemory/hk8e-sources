// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/framework/common/midb/mysql/src/mysql_mgr.cpp

// Line 23: range 000000000CA207EC-000000000CA20896
void __fastcall __static_initialization_and_destruction_0(int __initialize_p, int __priority)
{
  if ( __initialize_p == 1 )
  {
    __asan_before_dynamic_init("src/mysql_mgr.cpp");
