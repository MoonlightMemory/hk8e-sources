// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/hk4e_data/src/txt_data_auto/StateExcelConfig.gen.cpp

// Line 13: range 000000000CBB20B6-000000000CBB263E
int32_t __cdecl data::ElementStateExcelConfig::init(
        ...
        const common::tools::TxtFile::Row *row)
{
  ...
  *(_QWORD *)(v2 + 16) = data::ElementStateExcelConfig::init;
  v4 = (_DWORD *)(v2 >> 3);
  ...
  v5 = common::tools::TxtFile::Row::assignToEnum<data::ElementType>(
         row,
  ...
  *(_BYTE *)(((v2 + 32) >> 3) + 0x7FFF8000) = -8;
  if ( v5 )
  {
    *(_DWORD *)(((v2 + 128) >> 3) + 0x7FFF8000) = 0;
    ...
    common::milog::MiLogStream::create(
      ...
      4u,
      "./src/txt_data_auto/StateExcelConfig.gen.cpp",
      "init",
      16);
    v6 = common::milog::MiLogStream::operator<<<char [16],(char *[16])0>(
           (common::milog::MiLogStream *const)(v2 + 128),
           (const char (*)[16])"[CONFIG_ERROR] ");
    common::milog::MiLogStream::operator<<<char [33],(char *[33])0>(v6, (const char (*)[33])byte_1A148E80);
  ...
  else
  {
    ...
    *(_BYTE *)(((v2 + 48) >> 3) + 0x7FFF8000) = 1;
    ...
    v8 = common::tools::TxtFile::Row::assignToNum<unsigned int>(row, (const std::string *)(v2 + 192), &this->rank) != 0;
    ...
    if ( v8 )
    {
      *(_DWORD *)(((v2 + 256) >> 3) + 0x7FFF8000) = 0;
      ...
      v9 = common::milog::MiLogStream::operator<<<char [16],(char *[16])0>(
             ...
             (const char (*)[16])"[CONFIG_ERROR] ");
      common::milog::MiLogStream::operator<<<char [33],(char *[33])0>(v9, (const char (*)[33])byte_1A148F20);
...
// Line 29: range 000000000CBB2640-000000000CBB2E62
int32_t __cdecl data::StateExcelConfig::init(
        ...
        const common::tools::TxtFile::Row *row)
{
  ...
  *(_QWORD *)(v2 + 16) = data::StateExcelConfig::init;
  v4 = (_DWORD *)(v2 >> 3);
  v4[536862720] = -235802127;
  ...
  std::string::basic_string<std::allocator<char>>(
    ...
    &byte_1A148F80,
    (const std::allocator<char> *)(v2 + 48));
  v5 = common::tools::TxtFile::Row::assignToStr(row, (const std::string *)(v2 + 96), &this->state_name) != 0;
  ...
  *(_BYTE *)(((v2 + 48) >> 3) + 0x7FFF8000) = -8;
  if ( v5 )
  {
    *(_DWORD *)(((v2 + 160) >> 3) + 0x7FFF8000) = 0;
    ...
    v6 = common::milog::MiLogStream::operator<<<char [16],(char *[16])0>(
           ...
           (const char (*)[16])"[CONFIG_ERROR] ");
    common::milog::MiLogStream::operator<<<char [33],(char *[33])0>(v6, (const char (*)[33])byte_1A148FC0);
  ...
  else
  {
    ...
    *(_BYTE *)(((v2 + 64) >> 3) + 0x7FFF8000) = 1;
    ...
    v8 = common::tools::TxtFile::Row::assignToEnum<data::StateType>(
           row,
    ...
    *(_BYTE *)(((v2 + 64) >> 3) + 0x7FFF8000) = -8;
    if ( v8 )
    {
      *(_DWORD *)(((v2 + 288) >> 3) + 0x7FFF8000) = 0;
      ...
      v9 = common::milog::MiLogStream::operator<<<char [16],(char *[16])0>(
             ...
             (const char (*)[16])"[CONFIG_ERROR] ");
      common::milog::MiLogStream::operator<<<char [33],(char *[33])0>(v9, (const char (*)[33])byte_1A149060);
    ...
    else
    {
      ...
      *(_BYTE *)(((v2 + 80) >> 3) + 0x7FFF8000) = 1;
      ...
      v10 = common::tools::TxtFile::Row::assignToNum<unsigned int>(row, (const std::string *)(v2 + 352), &this->rank) != 0;
      ...
      if ( v10 )
      {
        *(_DWORD *)(((v2 + 416) >> 3) + 0x7FFF8000) = 0;
        ...
        v11 = common::milog::MiLogStream::operator<<<char [16],(char *[16])0>(
                ...
                (const char (*)[16])"[CONFIG_ERROR] ");
        common::milog::MiLogStream::operator<<<char [36],(char *[36])0>(v11, (const char (*)[36])byte_1A149100);
...
// Line 51: range 000000000CBB2E64-000000000CBB42C6
int32_t __cdecl data::StateExcelConfigMgrBase::loadElementStateExcelConfig(
        data::StateExcelConfigMgrBase *const this,
        HK4EDesignConfig *config)
{
  ...
  data::ElementStateExcelConfig *v41; // rax
  data::ElementStateExcelConfig *v42; // rdx
  int v43; // edx
  char *j; // r14
  ...
  *(_QWORD *)(v3 + 8) = "17 48 1 9 <unknown> 64 4 4 r:66 80 4 9 <unknown> 96 8 14 __for_begin:81 128 8 12 __for_end:81 16"
                        "0 8 9 <unknown> 192 8 4 i:85 224 16 7 data:69 256 32 8 paths:52 320 32 9 <unknown> 384 32 9 <unk"
                        "nown> 448 32 9 <unknown> 512 32 9 <unknown> 576 32 9 <unknown> 640 48 18 col_id_name_map:80 720 "
                        "376 23 debug_message_stream:77 1168 32880 11 txt_file:60";
  *(_QWORD *)(v3 + 16) = data::StateExcelConfigMgrBase::loadElementStateExcelConfig;
  v5 = (_DWORD *)(v3 >> 3);
      ...
      *(_BYTE *)(((v3 + 64) >> 3) + 0x7FFF8000) = 4;
      ...
      for ( *(_DWORD *)(v3 + 64) = 0; ; ++*(_DWORD *)(v3 + 64) )
      {
        ...
        *(_DWORD *)(v3 + 236) = 0;
        if ( row_ptr )
        {
          if ( data::ElementStateExcelConfig::init((data::ElementStateExcelConfig *const)(v3 + 224), row_ptr) )
          {
            ...
            if ( row_ptr->col_name_map_ptr )
            {
              ...
              *(_BYTE *)(((v3 + 192) >> 3) + 0x7FFF8000) = 0;
              ...
              for ( *(_QWORD *)(v3 + 192) = 0LL; ; ++*(_QWORD *)(v3 + 192) )
              {
                ...
                v27 = std::operator<<<std::char_traits<char>>(v26, &off_1A147560);
          ...
          {
            v41 = std::move<data::ElementStateExcelConfig &>((data::ElementStateExcelConfig *)(v3 + 224));
            std::vector<data::ElementStateExcelConfig>::emplace_back<data::ElementStateExcelConfig>(
              &this->element_state_excel_config_vec,
              v41,
              v42);
            v16 = 1;
          }
        ...
        data::ElementStateExcelConfig::~ElementStateExcelConfig((data::ElementStateExcelConfig *const)(v3 + 224));
...
// Line 107: range 000000000CBB42C8-000000000CBB56D8
int32_t __cdecl data::StateExcelConfigMgrBase::loadStateExcelConfig(
        data::StateExcelConfigMgrBase *const this,
        HK4EDesignConfig *config)
{
  int32_t v2; // r15d
  ...
  data::StateExcelConfig *v40; // rax
  data::StateExcelConfig *v41; // rdx
  ...
  *(_QWORD *)v3 = 1102416563LL;
  *(_QWORD *)(v3 + 8) = "17 32 1 9 <unknown> 48 4 5 r:122 64 4 9 <unknown> 80 8 15 __for_begin:137 112 8 13 __for_end:137"
                        " 144 8 9 <unknown> 176 8 5 i:141 208 32 9 paths:108 272 32 9 <unknown> 336 32 9 <unknown> 400 32"
                        " 9 <unknown> 464 32 9 <unknown> 528 32 9 <unknown> 592 48 8 data:125 672 48 19 col_id_name_map:1"
                        "36 752 376 24 debug_message_stream:133 1200 32880 12 txt_file:116";
  *(_QWORD *)(v3 + 16) = data::StateExcelConfigMgrBase::loadStateExcelConfig;
  v5 = (_DWORD *)(v3 >> 3);
  v5[536862720] = -235802127;
    ...
    else
    {
      *(_BYTE *)(((v3 + 48) >> 3) + 0x7FFF8000) = 4;
      ...
      for ( *(_DWORD *)(v3 + 48) = 0; ; ++*(_DWORD *)(v3 + 48) )
      {
        ...
        *(_DWORD *)v13 = 0;
        *(_WORD *)(v13 + 4) = 0;
        data::StateExcelConfig::StateExcelConfig((data::StateExcelConfig *const)(v3 + 592));
        if ( row_ptr )
        {
          if ( data::StateExcelConfig::init((data::StateExcelConfig *const)(v3 + 592), row_ptr) )
          {
          ...
          {
            v40 = std::move<data::StateExcelConfig &>((data::StateExcelConfig *)(v3 + 592));
            std::vector<data::StateExcelConfig>::emplace_back<data::StateExcelConfig>(
              &this->state_excel_config_vec,
              v40,
              v41);
            v15 = 1;
          }
...
// Line 163: range 000000000CBB56DA-000000000CBB59FE
int32_t __cdecl data::StateExcelConfigMgrBase::loadConfig(
        data::StateExcelConfigMgrBase *const this,
        HK4EDesignConfig *config)
{
  ...
  *(_QWORD *)(v2 + 16) = data::StateExcelConfigMgrBase::loadConfig;
  v4 = (_DWORD *)(v2 >> 3);
  v4[536862720] = -235802127;
  v4[536862722] = -218959118;
  v4[536862724] = -202116109;
  if ( data::StateExcelConfigMgrBase::loadElementStateExcelConfig(this, config) )
  {
    ...
    common::milog::MiLogStream::operator<<<char [35],(char *[35])0>(
      v5,
      (const char (*)[35])"loadElementStateExcelConfig failed");
    common::milog::MiLogStream::~MiLogStream((common::milog::MiLogStream *const)(v2 + 32));
    result = -1;
  }
  else if ( data::StateExcelConfigMgrBase::loadStateExcelConfig(this, config) )
  {
    ...
    common::milog::MiLogStream::operator<<<char [28],(char *[28])0>(
      v7,
      (const char (*)[28])"loadStateExcelConfig failed");
...
// Line 178: range 000000000CBB5A00-000000000CBB5A12
int32_t __cdecl data::StateExcelConfigMgrBase::rewriteConfig(
        data::StateExcelConfigMgrBase *const this,
...
// Line 183: range 000000000CBB5A14-000000000CBB5A26
int32_t __cdecl data::StateExcelConfigMgrBase::finalConfig(
        data::StateExcelConfigMgrBase *const this,
        TxtConfigMgr *txt_config_mgr)
{
  return 0;
