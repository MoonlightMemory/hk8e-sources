// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/hk4e_proto/src/server_only/log/mail/mail_head.pb.cc

// Line 72: range 0000000015021147-0000000015021310
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptors()
{
  ...
  *(_QWORD *)(v0 + 16) = proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptors;
  v2 = (_DWORD *)(v0 >> 3);
  v2[536862720] = -235802127;
  v2[536862721] = -234753551;
  v2[536862723] = -202116109;
  proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::AddDescriptors();
  std::allocator<char>::allocator(v0 + 48);
  std::string::basic_string<std::allocator<char>>(
    (std::string *const)(v0 + 64),
    "server_only/log/mail/mail_head.proto",
    (const std::allocator<char> *)(v0 + 48));
  google::protobuf::internal::AssignDescriptors(
    v0 + 64,
    (int)&proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::schemas,
    (int)proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::file_default_instances,
    (int)proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::TableStruct::offsets,
    0,
    (int)proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::file_level_metadata,
    0LL,
    0LL,
    v3,
    0,
...
// Line 80: range 0000000015021311-000000001502132A
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce()
{
  google::protobuf::GoogleOnceInit(
    &proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce(void)::once,
    proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptors);
};

// Line 86: range 000000001502132B-000000001502134F
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_RegisterTypes(
        const std::string *a1)
{
  proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce();
  google::protobuf::internal::RegisterAllTypes(
    proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::file_level_metadata,
    1);
};

// Line 92: range 0000000015021350-000000001502138F
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::TableStruct::InitDefaultsImpl()
{
  const char *v0; // rcx
  ...
  google::protobuf::internal::VerifyVersion(
    ...
    3004000,
    "./src/server_only/log/mail/mail_head.pb.cc",
    v0);
  google::protobuf::internal::InitProtobufDefaults((google::protobuf::internal *)0x2DD660);
  google::protobuf::internal::ExplicitlyConstructed<proto_log::MailLogHead>::DefaultConstruct(&proto_log::_MailLogHead_default_instance_._instance);
  google::protobuf::internal::OnShutdownDestroyMessage(
    (google::protobuf::internal *)&proto_log::_MailLogHead_default_instance_,
    (const void *)0x2DD660);
};

// Line 100: range 0000000015021390-00000000150213AC
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::InitDefaults()
{
  google::protobuf::GoogleOnceInit(
    &proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::InitDefaults(void)::once,
    proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::TableStruct::InitDefaultsImpl);
};

// Line 105: range 00000000150213AD-00000000150213DC
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::AddDescriptorsImpl();

// Line 121: range 00000000150213DD-00000000150213F6
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::AddDescriptors()
{
  google::protobuf::GoogleOnceInit(
    &proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::AddDescriptors(void)::once,
    proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::AddDescriptorsImpl);
};

// Line 127: range 00000000160E184A-00000000160E185D
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::StaticDescriptorInitializer::StaticDescriptorInitializer(
        proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::StaticDescriptorInitializer *const this)
{
  proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::AddDescriptors();
};

// Line 145: range 00000000150213F8-00000000150214B7
void __cdecl proto_log::MailLogHead::MailLogHead(proto_log::MailLogHead *const this)
{
  int (**v1)(...); // rdx
  ...
  if ( this != proto_log::MailLogHead::internal_default_instance() )
    proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::InitDefaults();
  proto_log::MailLogHead::SharedCtor(this);
};

// Line 153: range 00000000150214B8-00000000150218E5
void __cdecl proto_log::MailLogHead::MailLogHead(
        proto_log::MailLogHead *const this,
        const proto_log::MailLogHead *from)
{
  int (**v2)(...); // rdx
  ...
  v5 = proto_log::MailLogHead::time[abi:cxx11](from);
  ...
  v8 = proto_log::MailLogHead::action_name[abi:cxx11](from);
  ...
  v11 = proto_log::MailLogHead::sub_action_name[abi:cxx11](from);
...
// Line 176: range 00000000150218E6-000000001502199A
void __cdecl proto_log::MailLogHead::SharedCtor(proto_log::MailLogHead *const this)
{
...
// Line 186: range 000000001502199C-0000000015021A05
void __cdecl proto_log::MailLogHead::~MailLogHead(proto_log::MailLogHead *const this)
{
  int (**v1)(...); // rdx
  ...
  if ( *(_BYTE *)(((unsigned __int64)this >> 3) + 0x7FFF8000) )
    __asan_report_store8();
  this->_vptr_MessageLite = v1;
  proto_log::MailLogHead::SharedDtor(this);
  google::protobuf::internal::InternalMetadataWithArena::~InternalMetadataWithArena(&this->_internal_metadata_);
  google::protobuf::Message::~Message(this);
};

// Line 186: range 0000000015021A06-0000000015021A30
void __cdecl proto_log::MailLogHead::~MailLogHead(proto_log::MailLogHead *const this)
{
  proto_log::MailLogHead::~MailLogHead(this);
  operator delete(this, 0x38uLL);
};

// Line 191: range 0000000015021A32-0000000015021A8E
void __cdecl proto_log::MailLogHead::SharedDtor(proto_log::MailLogHead *const this)
{
  const std::string *v1; // rax
  const std::string *v2; // rax
  const std::string *v3; // rax
...
// Line 197: range 0000000015021A90-0000000015021ADE
void __cdecl proto_log::MailLogHead::SetCachedSize(const proto_log::MailLogHead *const this, int size)
{
  if ( *(_BYTE *)(((unsigned __int64)&this->_cached_size_ >> 3) + 0x7FFF8000) != 0
    && *(_BYTE *)(((unsigned __int64)&this->_cached_size_ >> 3) + 0x7FFF8000) <= 3 )
  {
...
// Line 202: range 0000000015021AE0-0000000015021AF1
const google::protobuf::Descriptor *__cdecl proto_log::MailLogHead::descriptor()
{
  proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce();
  return proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::file_level_metadata[0].descriptor;
};

// Line 207: range 0000000015021AF2-0000000015021B01
const proto_log::MailLogHead *__cdecl proto_log::MailLogHead::default_instance()
{
  proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::InitDefaults();
  return proto_log::MailLogHead::internal_default_instance();
};

// Line 212: range 0000000015021B02-0000000015021B76
proto_log::MailLogHead *__cdecl proto_log::MailLogHead::New(
        const proto_log::MailLogHead *const this,
        google::protobuf::Arena *arena)
{
  proto_log::MailLogHead *v2; // rbx

  v2 = (proto_log::MailLogHead *)operator new(0x38uLL);
  proto_log::MailLogHead::MailLogHead(v2);
  if ( arena )
    google::protobuf::Arena::Own<proto_log::MailLogHead>(arena, v2);
  return v2;
};

// Line 220: range 0000000015021B78-0000000015021C53
void __cdecl proto_log::MailLogHead::Clear(proto_log::MailLogHead *const this)
{
  const std::string *v1; // rax
  const std::string *v2; // rax
  const std::string *v3; // rax
...
// Line 236: range 0000000015021C54-00000000150227BC
bool __cdecl proto_log::MailLogHead::MergePartialFromCodedStream(
        proto_log::MailLogHead *const this,
        google::protobuf::io::CodedInputStream *input)
{
  ...
  *(_QWORD *)(v2 + 16) = proto_log::MailLogHead::MergePartialFromCodedStream;
  v4 = (_DWORD *)(v2 >> 3);
      ...
      if ( *(_BYTE *)(v2 + 132) == 1 )
      {
        switch ( google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag) )
        {
          case 1:
            if ( (_BYTE)tag != 10 )
              break;
            v13 = proto_log::MailLogHead::mutable_time[abi:cxx11](this);
            if ( !google::protobuf::internal::WireFormatLite::ReadString(input, v13) )
              goto failure;
            v14 = proto_log::MailLogHead::time[abi:cxx11](this);
            v15 = std::string::length(v14);
            v16 = proto_log::MailLogHead::time[abi:cxx11](this);
            ...
            if ( !(unsigned __int8)google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                                     ...
                                     (const char *)v15,
                                     0,
                                     (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.time",
                                     v18) )
              goto failure;
            continue;
          case 2:
          ...
          case 3:
            if ( (_BYTE)tag != 26 )
              goto handle_unusual;
            v19 = proto_log::MailLogHead::mutable_action_name[abi:cxx11](this);
            if ( !google::protobuf::internal::WireFormatLite::ReadString(input, v19) )
              goto failure;
            v20 = proto_log::MailLogHead::action_name[abi:cxx11](this);
            v21 = std::string::length(v20);
            v22 = proto_log::MailLogHead::action_name[abi:cxx11](this);
            v23 = (google::protobuf::internal::WireFormatLite *)std::string::data(v22);
            if ( !(unsigned __int8)google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                                     v23,
                                     (const char *)v21,
                                     0,
                                     (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.action_name",
                                     v24) )
              goto failure;
            continue;
          case 4:
          ...
          case 5:
            if ( (_BYTE)tag != 42 )
              goto handle_unusual;
            v25 = proto_log::MailLogHead::mutable_sub_action_name[abi:cxx11](this);
            if ( !google::protobuf::internal::WireFormatLite::ReadString(input, v25) )
              goto failure;
            v26 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
            v27 = std::string::length(v26);
            v28 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
            v29 = (google::protobuf::internal::WireFormatLite *)std::string::data(v28);
            if ( !(unsigned __int8)google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                                     v29,
                                     (const char *)v27,
                                     0,
                                     (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.sub_action_name",
                                     v30) )
              goto failure;
            continue;
          default:
...
// Line 342: range 00000000150227BE-0000000015022ABE
void __cdecl proto_log::MailLogHead::SerializeWithCachedSizes(
        const proto_log::MailLogHead *const this,
        google::protobuf::io::CodedOutputStream *output)
{
  ...
  v2 = proto_log::MailLogHead::time[abi:cxx11](this);
  if ( std::string::size(v2) )
  {
    v3 = proto_log::MailLogHead::time[abi:cxx11](this);
    v4 = std::string::length(v3);
    v5 = proto_log::MailLogHead::time[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.time",
      v7);
    v8 = proto_log::MailLogHead::time[abi:cxx11](this);
    google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(1LL, v8, output);
  }
  if ( proto_log::MailLogHead::action_id(this) )
  {
    v9 = proto_log::MailLogHead::action_id(this);
    google::protobuf::internal::WireFormatLite::WriteUInt32(2, v9, output);
  }
  v10 = proto_log::MailLogHead::action_name[abi:cxx11](this);
  if ( std::string::size(v10) )
  {
    v11 = proto_log::MailLogHead::action_name[abi:cxx11](this);
    v12 = std::string::length(v11);
    v13 = proto_log::MailLogHead::action_name[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.action_name",
      v15);
    v16 = proto_log::MailLogHead::action_name[abi:cxx11](this);
    google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(3LL, v16, output);
  }
  if ( proto_log::MailLogHead::sub_action_id(this) )
  {
    v17 = proto_log::MailLogHead::sub_action_id(this);
    google::protobuf::internal::WireFormatLite::WriteUInt32(4, v17, output);
  }
  v18 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
  if ( std::string::size(v18) )
  {
    v19 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
    v20 = std::string::length(v19);
    v21 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.sub_action_name",
      v23);
    v24 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
...
// Line 395: range 0000000015022AC0-0000000015022DE0
google::protobuf::uint8 *__cdecl proto_log::MailLogHead::InternalSerializeWithCachedSizesToArray(
        const proto_log::MailLogHead *const this,
        bool deterministic,
        google::protobuf::uint8 *target)
{
  ...
  {
    v4 = proto_log::MailLogHead::time[abi:cxx11](this);
    v5 = std::string::length(v4);
    v6 = proto_log::MailLogHead::time[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.time",
      v8);
    v9 = proto_log::MailLogHead::time[abi:cxx11](this);
    target = google::protobuf::internal::WireFormatLite::WriteStringToArray(1, v9, target);
  }
  if ( proto_log::MailLogHead::action_id(this) )
  {
    v10 = proto_log::MailLogHead::action_id(this);
    target = google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, v10, target);
  }
  v11 = proto_log::MailLogHead::action_name[abi:cxx11](this);
  if ( std::string::size(v11) )
  {
    v12 = proto_log::MailLogHead::action_name[abi:cxx11](this);
    v13 = std::string::length(v12);
    v14 = proto_log::MailLogHead::action_name[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.action_name",
      v16);
    v17 = proto_log::MailLogHead::action_name[abi:cxx11](this);
    target = google::protobuf::internal::WireFormatLite::WriteStringToArray(3, v17, target);
  }
  if ( proto_log::MailLogHead::sub_action_id(this) )
  {
    v18 = proto_log::MailLogHead::sub_action_id(this);
    target = google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, v18, target);
  }
  v19 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
  if ( std::string::size(v19) )
  {
    v20 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
    v21 = std::string::length(v20);
    v22 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
    v23 = (google::protobuf::internal::WireFormatLite *)std::string::data(v22);
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      v23,
      (const char *)v21,
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MailLogHead.sub_action_name",
      v24);
    v25 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
...
// Line 452: range 0000000015022DE2-0000000015023044
size_t __cdecl proto_log::MailLogHead::ByteSizeLong(const proto_log::MailLogHead *const this)
{
...
LABEL_13:
  ...
  v5 = proto_log::MailLogHead::action_name[abi:cxx11](this);
  if ( std::string::size(v5) )
  {
    v6 = proto_log::MailLogHead::action_name[abi:cxx11](this);
    total_size += google::protobuf::internal::WireFormatLite::StringSize(v6) + 1;
  }
  v7 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
  if ( std::string::size(v7) )
  {
    v8 = proto_log::MailLogHead::sub_action_name[abi:cxx11](this);
  ...
  if ( proto_log::MailLogHead::sub_action_id(this) )
  {
    v10 = proto_log::MailLogHead::sub_action_id(this);
...
// Line 503: range 0000000015023046-00000000150232CF
void __cdecl proto_log::MailLogHead::MergeFrom(
        proto_log::MailLogHead *const this,
        const google::protobuf::Message *from)
{
  ...
  const proto_log::MailLogHead *source; // [rsp+28h] [rbp-D8h]
  ...
  *(_QWORD *)(v2 + 16) = proto_log::MailLogHead::MergeFrom;
  v4 = (_DWORD *)(v2 >> 3);
  v4[536862720] = -235802127;
  ...
  source = google::protobuf::internal::DynamicCastToGenerated<proto_log::MailLogHead const>(from);
  if ( source )
    proto_log::MailLogHead::MergeFrom(this, source);
  else
...
// Line 518: range 00000000150232D0-0000000015023800
void __cdecl proto_log::MailLogHead::MergeFrom(proto_log::MailLogHead *const this, const proto_log::MailLogHead *from)
{
  unsigned __int64 v2; // rbx
  __int64 v3; // rax
  _DWORD *v4; // r12
  ...
  *(_QWORD *)(v2 + 16) = proto_log::MailLogHead::MergeFrom;
  ...
  v10 = proto_log::MailLogHead::time[abi:cxx11](from);
  if ( std::string::size(v10) )
  {
  ...
  v12 = proto_log::MailLogHead::action_name[abi:cxx11](from);
  ...
  v14 = proto_log::MailLogHead::sub_action_name[abi:cxx11](from);
  ...
  if ( proto_log::MailLogHead::action_id(from) )
  {
    v16 = proto_log::MailLogHead::action_id(from);
    proto_log::MailLogHead::set_action_id(this, v16);
  }
  if ( proto_log::MailLogHead::sub_action_id(from) )
  {
    v17 = proto_log::MailLogHead::sub_action_id(from);
    proto_log::MailLogHead::set_sub_action_id(this, v17);
  }
  if ( v20 == (char *)v2 )
  {
    *(_QWORD *)((v2 >> 3) + 0x7FFF8000) = 0LL;
...
// Line 545: range 0000000015023802-000000001502383F
void __cdecl proto_log::MailLogHead::CopyFrom(
        proto_log::MailLogHead *const this,
        const google::protobuf::Message *from)
{
  if ( from != this )
  {
    proto_log::MailLogHead::Clear(this);
    proto_log::MailLogHead::MergeFrom(this, from);
  }
};

// Line 552: range 0000000015023840-000000001502387D
void __cdecl proto_log::MailLogHead::CopyFrom(proto_log::MailLogHead *const this, const proto_log::MailLogHead *from)
{
  if ( from != this )
  {
    proto_log::MailLogHead::Clear(this);
...
// Line 559: range 000000001502387E-000000001502388C
bool __cdecl proto_log::MailLogHead::IsInitialized(const proto_log::MailLogHead *const this)
{
  return 1;
};

// Line 563: range 000000001502388E-00000000150238BF
void __cdecl proto_log::MailLogHead::Swap(proto_log::MailLogHead *const this, proto_log::MailLogHead *other)
{
  if ( other != this )
    proto_log::MailLogHead::InternalSwap(this, other);
};

// Line 567: range 00000000150238C0-0000000015023B16
void __cdecl proto_log::MailLogHead::InternalSwap(proto_log::MailLogHead *const this, proto_log::MailLogHead *other)
{
  char v2; // al
  google::protobuf::internal::InternalMetadataWithArenaBase<google::protobuf::UnknownFieldSet,google::protobuf::internal::InternalMetadataWithArena>::Container *v3; // rdx
...
// Line 578: range 0000000015023B18-0000000015023B38
google::protobuf::Metadata __cdecl proto_log::MailLogHead::GetMetadata(const proto_log::MailLogHead *const this)
{
  proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce();
  return proto_log::protobuf_server_5fonly_2flog_2fmail_2fmail_5fhead_2eproto::`anonymous namespace'::file_level_metadata[0];
};
