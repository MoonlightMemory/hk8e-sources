// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/hk4e_proto/src/server_only/log/match/match_head.pb.cc

// Line 72: range 0000000017427FDF-00000000174281A8
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptors()
{
  ...
  *(_QWORD *)(v0 + 16) = proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptors;
  v2 = (_DWORD *)(v0 >> 3);
  v2[536862720] = -235802127;
  v2[536862721] = -234753551;
  v2[536862723] = -202116109;
  proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::AddDescriptors();
  std::allocator<char>::allocator(v0 + 48);
  std::string::basic_string<std::allocator<char>>(
    (std::string *const)(v0 + 64),
    "server_only/log/match/match_head.proto",
    (const std::allocator<char> *)(v0 + 48));
  google::protobuf::internal::AssignDescriptors(
    v0 + 64,
    (int)&proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::schemas,
    (int)proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::file_default_instances,
    (int)proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::TableStruct::offsets,
    0,
    (int)proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::file_level_metadata,
    0LL,
    0LL,
    v3,
    0,
...
// Line 80: range 00000000174281A9-00000000174281C2
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce()
{
  google::protobuf::GoogleOnceInit(
    &proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce(void)::once,
    proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptors);
};

// Line 86: range 00000000174281C3-00000000174281E7
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_RegisterTypes(
        const std::string *a1)
{
  proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce();
  google::protobuf::internal::RegisterAllTypes(
    proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::file_level_metadata,
    1);
};

// Line 92: range 00000000174281E8-0000000017428227
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::TableStruct::InitDefaultsImpl()
{
  const char *v0; // rcx
  ...
  google::protobuf::internal::VerifyVersion(
    ...
    3004000,
    "./src/server_only/log/match/match_head.pb.cc",
    v0);
  google::protobuf::internal::InitProtobufDefaults((google::protobuf::internal *)0x2DD660);
  google::protobuf::internal::ExplicitlyConstructed<proto_log::MatchLogHead>::DefaultConstruct(&proto_log::_MatchLogHead_default_instance_._instance);
  google::protobuf::internal::OnShutdownDestroyMessage(
    (google::protobuf::internal *)&proto_log::_MatchLogHead_default_instance_,
    (const void *)0x2DD660);
};

// Line 100: range 0000000017428228-0000000017428244
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::InitDefaults()
{
  google::protobuf::GoogleOnceInit(
    &proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::InitDefaults(void)::once,
    proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::TableStruct::InitDefaultsImpl);
};

// Line 105: range 0000000017428245-0000000017428274
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::AddDescriptorsImpl();

// Line 121: range 0000000017428275-000000001742828E
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::AddDescriptors()
{
  google::protobuf::GoogleOnceInit(
    &proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::AddDescriptors(void)::once,
    proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::AddDescriptorsImpl);
};

// Line 127: range 00000000178BC08A-00000000178BC09D
void __cdecl proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::StaticDescriptorInitializer::StaticDescriptorInitializer(
        proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::StaticDescriptorInitializer *const this)
{
  proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::AddDescriptors();
};

// Line 145: range 0000000017428290-000000001742834F
void __cdecl proto_log::MatchLogHead::MatchLogHead(proto_log::MatchLogHead *const this)
{
  int (**v1)(...); // rdx
  ...
  if ( this != proto_log::MatchLogHead::internal_default_instance() )
    proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::InitDefaults();
  proto_log::MatchLogHead::SharedCtor(this);
};

// Line 153: range 0000000017428350-000000001742877D
void __cdecl proto_log::MatchLogHead::MatchLogHead(
        proto_log::MatchLogHead *const this,
        const proto_log::MatchLogHead *from)
{
  int (**v2)(...); // rdx
  ...
  v5 = proto_log::MatchLogHead::time[abi:cxx11](from);
  ...
  v8 = proto_log::MatchLogHead::action_name[abi:cxx11](from);
  ...
  v11 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](from);
...
// Line 176: range 000000001742877E-0000000017428832
void __cdecl proto_log::MatchLogHead::SharedCtor(proto_log::MatchLogHead *const this)
{
...
// Line 186: range 0000000017428834-000000001742889D
void __cdecl proto_log::MatchLogHead::~MatchLogHead(proto_log::MatchLogHead *const this)
{
  int (**v1)(...); // rdx
  ...
  if ( *(_BYTE *)(((unsigned __int64)this >> 3) + 0x7FFF8000) )
    __asan_report_store8();
  this->_vptr_MessageLite = v1;
  proto_log::MatchLogHead::SharedDtor(this);
  google::protobuf::internal::InternalMetadataWithArena::~InternalMetadataWithArena(&this->_internal_metadata_);
  google::protobuf::Message::~Message(this);
};

// Line 186: range 000000001742889E-00000000174288C8
void __cdecl proto_log::MatchLogHead::~MatchLogHead(proto_log::MatchLogHead *const this)
{
  proto_log::MatchLogHead::~MatchLogHead(this);
  operator delete(this, 0x38uLL);
};

// Line 191: range 00000000174288CA-0000000017428926
void __cdecl proto_log::MatchLogHead::SharedDtor(proto_log::MatchLogHead *const this)
{
  const std::string *v1; // rax
  const std::string *v2; // rax
  const std::string *v3; // rax
...
// Line 197: range 0000000017428928-0000000017428976
void __cdecl proto_log::MatchLogHead::SetCachedSize(const proto_log::MatchLogHead *const this, int size)
{
  if ( *(_BYTE *)(((unsigned __int64)&this->_cached_size_ >> 3) + 0x7FFF8000) != 0
    && *(_BYTE *)(((unsigned __int64)&this->_cached_size_ >> 3) + 0x7FFF8000) <= 3 )
  {
...
// Line 202: range 0000000017428978-0000000017428989
const google::protobuf::Descriptor *__cdecl proto_log::MatchLogHead::descriptor()
{
  proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce();
  return proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::file_level_metadata[0].descriptor;
};

// Line 207: range 000000001742898A-0000000017428999
const proto_log::MatchLogHead *__cdecl proto_log::MatchLogHead::default_instance()
{
  proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::InitDefaults();
  return proto_log::MatchLogHead::internal_default_instance();
};

// Line 212: range 000000001742899A-0000000017428A0E
proto_log::MatchLogHead *__cdecl proto_log::MatchLogHead::New(
        const proto_log::MatchLogHead *const this,
        google::protobuf::Arena *arena)
{
  proto_log::MatchLogHead *v2; // rbx

  v2 = (proto_log::MatchLogHead *)operator new(0x38uLL);
  proto_log::MatchLogHead::MatchLogHead(v2);
  if ( arena )
    google::protobuf::Arena::Own<proto_log::MatchLogHead>(arena, v2);
  return v2;
};

// Line 220: range 0000000017428A10-0000000017428AEB
void __cdecl proto_log::MatchLogHead::Clear(proto_log::MatchLogHead *const this)
{
  const std::string *v1; // rax
  const std::string *v2; // rax
  const std::string *v3; // rax
...
// Line 236: range 0000000017428AEC-0000000017429654
bool __cdecl proto_log::MatchLogHead::MergePartialFromCodedStream(
        proto_log::MatchLogHead *const this,
        google::protobuf::io::CodedInputStream *input)
{
  ...
  *(_QWORD *)(v2 + 16) = proto_log::MatchLogHead::MergePartialFromCodedStream;
  v4 = (_DWORD *)(v2 >> 3);
      ...
      if ( *(_BYTE *)(v2 + 132) == 1 )
      {
        switch ( google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag) )
        {
          case 1:
            if ( (_BYTE)tag != 10 )
              break;
            v13 = proto_log::MatchLogHead::mutable_time[abi:cxx11](this);
            if ( !google::protobuf::internal::WireFormatLite::ReadString(input, v13) )
              goto failure;
            v14 = proto_log::MatchLogHead::time[abi:cxx11](this);
            v15 = std::string::length(v14);
            v16 = proto_log::MatchLogHead::time[abi:cxx11](this);
            ...
            if ( !(unsigned __int8)google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                                     ...
                                     (const char *)v15,
                                     0,
                                     (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.time",
                                     v18) )
              goto failure;
            continue;
          case 2:
          ...
          case 3:
            if ( (_BYTE)tag != 26 )
              goto handle_unusual;
            v19 = proto_log::MatchLogHead::mutable_action_name[abi:cxx11](this);
            if ( !google::protobuf::internal::WireFormatLite::ReadString(input, v19) )
              goto failure;
            v20 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
            v21 = std::string::length(v20);
            v22 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
            v23 = (google::protobuf::internal::WireFormatLite *)std::string::data(v22);
            if ( !(unsigned __int8)google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                                     v23,
                                     (const char *)v21,
                                     0,
                                     (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.action_name",
                                     v24) )
              goto failure;
            continue;
          case 4:
          ...
          case 5:
            if ( (_BYTE)tag != 42 )
              goto handle_unusual;
            v25 = proto_log::MatchLogHead::mutable_sub_action_name[abi:cxx11](this);
            if ( !google::protobuf::internal::WireFormatLite::ReadString(input, v25) )
              goto failure;
            v26 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
            v27 = std::string::length(v26);
            v28 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
            v29 = (google::protobuf::internal::WireFormatLite *)std::string::data(v28);
            if ( !(unsigned __int8)google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                                     v29,
                                     (const char *)v27,
                                     0,
                                     (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.sub_action_name",
                                     v30) )
              goto failure;
            continue;
          default:
...
// Line 342: range 0000000017429656-0000000017429956
void __cdecl proto_log::MatchLogHead::SerializeWithCachedSizes(
        const proto_log::MatchLogHead *const this,
        google::protobuf::io::CodedOutputStream *output)
{
  ...
  v2 = proto_log::MatchLogHead::time[abi:cxx11](this);
  if ( std::string::size(v2) )
  {
    v3 = proto_log::MatchLogHead::time[abi:cxx11](this);
    v4 = std::string::length(v3);
    v5 = proto_log::MatchLogHead::time[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.time",
      v7);
    v8 = proto_log::MatchLogHead::time[abi:cxx11](this);
    google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(1LL, v8, output);
  }
  if ( proto_log::MatchLogHead::action_id(this) )
  {
    v9 = proto_log::MatchLogHead::action_id(this);
    google::protobuf::internal::WireFormatLite::WriteUInt32(2, v9, output);
  }
  v10 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
  if ( std::string::size(v10) )
  {
    v11 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
    v12 = std::string::length(v11);
    v13 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.action_name",
      v15);
    v16 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
    google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(3LL, v16, output);
  }
  if ( proto_log::MatchLogHead::sub_action_id(this) )
  {
    v17 = proto_log::MatchLogHead::sub_action_id(this);
    google::protobuf::internal::WireFormatLite::WriteUInt32(4, v17, output);
  }
  v18 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
  if ( std::string::size(v18) )
  {
    v19 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
    v20 = std::string::length(v19);
    v21 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.sub_action_name",
      v23);
    v24 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
...
// Line 395: range 0000000017429958-0000000017429C78
google::protobuf::uint8 *__cdecl proto_log::MatchLogHead::InternalSerializeWithCachedSizesToArray(
        const proto_log::MatchLogHead *const this,
        bool deterministic,
        google::protobuf::uint8 *target)
{
  ...
  {
    v4 = proto_log::MatchLogHead::time[abi:cxx11](this);
    v5 = std::string::length(v4);
    v6 = proto_log::MatchLogHead::time[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.time",
      v8);
    v9 = proto_log::MatchLogHead::time[abi:cxx11](this);
    target = google::protobuf::internal::WireFormatLite::WriteStringToArray(1, v9, target);
  }
  if ( proto_log::MatchLogHead::action_id(this) )
  {
    v10 = proto_log::MatchLogHead::action_id(this);
    target = google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, v10, target);
  }
  v11 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
  if ( std::string::size(v11) )
  {
    v12 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
    v13 = std::string::length(v12);
    v14 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
    ...
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.action_name",
      v16);
    v17 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
    target = google::protobuf::internal::WireFormatLite::WriteStringToArray(3, v17, target);
  }
  if ( proto_log::MatchLogHead::sub_action_id(this) )
  {
    v18 = proto_log::MatchLogHead::sub_action_id(this);
    target = google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, v18, target);
  }
  v19 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
  if ( std::string::size(v19) )
  {
    v20 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
    v21 = std::string::length(v20);
    v22 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
    v23 = (google::protobuf::internal::WireFormatLite *)std::string::data(v22);
    google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      v23,
      (const char *)v21,
      ...
      (google::protobuf::internal::WireFormatLite::Operation)"proto_log.MatchLogHead.sub_action_name",
      v24);
    v25 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
...
// Line 452: range 0000000017429C7A-0000000017429EDC
size_t __cdecl proto_log::MatchLogHead::ByteSizeLong(const proto_log::MatchLogHead *const this)
{
...
LABEL_13:
  ...
  v5 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
  if ( std::string::size(v5) )
  {
    v6 = proto_log::MatchLogHead::action_name[abi:cxx11](this);
    total_size += google::protobuf::internal::WireFormatLite::StringSize(v6) + 1;
  }
  v7 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
  if ( std::string::size(v7) )
  {
    v8 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](this);
  ...
  if ( proto_log::MatchLogHead::sub_action_id(this) )
  {
    v10 = proto_log::MatchLogHead::sub_action_id(this);
...
// Line 503: range 0000000017429EDE-000000001742A167
void __cdecl proto_log::MatchLogHead::MergeFrom(
        proto_log::MatchLogHead *const this,
        const google::protobuf::Message *from)
{
  ...
  const proto_log::MatchLogHead *source; // [rsp+28h] [rbp-D8h]
  ...
  *(_QWORD *)(v2 + 16) = proto_log::MatchLogHead::MergeFrom;
  v4 = (_DWORD *)(v2 >> 3);
  v4[536862720] = -235802127;
  ...
  source = google::protobuf::internal::DynamicCastToGenerated<proto_log::MatchLogHead const>(from);
  if ( source )
    proto_log::MatchLogHead::MergeFrom(this, source);
  else
...
// Line 518: range 000000001742A168-000000001742A698
void __cdecl proto_log::MatchLogHead::MergeFrom(
        proto_log::MatchLogHead *const this,
        const proto_log::MatchLogHead *from)
{
  ...
  *(_QWORD *)(v2 + 16) = proto_log::MatchLogHead::MergeFrom;
  ...
  v10 = proto_log::MatchLogHead::time[abi:cxx11](from);
  if ( std::string::size(v10) )
  {
  ...
  v12 = proto_log::MatchLogHead::action_name[abi:cxx11](from);
  ...
  v14 = proto_log::MatchLogHead::sub_action_name[abi:cxx11](from);
  ...
  if ( proto_log::MatchLogHead::action_id(from) )
  {
    v16 = proto_log::MatchLogHead::action_id(from);
    proto_log::MatchLogHead::set_action_id(this, v16);
  }
  if ( proto_log::MatchLogHead::sub_action_id(from) )
  {
    v17 = proto_log::MatchLogHead::sub_action_id(from);
    proto_log::MatchLogHead::set_sub_action_id(this, v17);
  }
  if ( v20 == (char *)v2 )
  {
    *(_QWORD *)((v2 >> 3) + 0x7FFF8000) = 0LL;
...
// Line 545: range 000000001742A69A-000000001742A6D7
void __cdecl proto_log::MatchLogHead::CopyFrom(
        proto_log::MatchLogHead *const this,
        const google::protobuf::Message *from)
{
  if ( from != this )
  {
    proto_log::MatchLogHead::Clear(this);
    proto_log::MatchLogHead::MergeFrom(this, from);
  }
};

// Line 552: range 000000001742A6D8-000000001742A715
void __cdecl proto_log::MatchLogHead::CopyFrom(
        proto_log::MatchLogHead *const this,
        const proto_log::MatchLogHead *from)
{
...
// Line 559: range 000000001742A716-000000001742A724
bool __cdecl proto_log::MatchLogHead::IsInitialized(const proto_log::MatchLogHead *const this)
{
  return 1;
};

// Line 563: range 000000001742A726-000000001742A757
void __cdecl proto_log::MatchLogHead::Swap(proto_log::MatchLogHead *const this, proto_log::MatchLogHead *other)
{
  if ( other != this )
    proto_log::MatchLogHead::InternalSwap(this, other);
};

// Line 567: range 000000001742A758-000000001742A9AE
void __cdecl proto_log::MatchLogHead::InternalSwap(proto_log::MatchLogHead *const this, proto_log::MatchLogHead *other)
{
  char v2; // al
  google::protobuf::internal::InternalMetadataWithArenaBase<google::protobuf::UnknownFieldSet,google::protobuf::internal::InternalMetadataWithArena>::Container *v3; // rdx
...
// Line 578: range 000000001742A9B0-000000001742A9D0
google::protobuf::Metadata __cdecl proto_log::MatchLogHead::GetMetadata(const proto_log::MatchLogHead *const this)
{
  proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::protobuf_AssignDescriptorsOnce();
  return proto_log::protobuf_server_5fonly_2flog_2fmatch_2fmatch_5fhead_2eproto::`anonymous namespace'::file_level_metadata[0];
};
